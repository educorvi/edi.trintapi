...
#
#  $ bin/test -s edi.trintapi -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src edi.trintapi.testing.EDI_TRINTAPI_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/edi/trintapi/tests/robot/test_example.robot
#
